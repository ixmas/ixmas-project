...
public class SingleThreadMatrixMultiplierTest {

    @Test
    public void shouldComputeCorrectlyNullMatrix() {
        org.ixmas.ixmatrixmult.application.singlethread.SingleThreadMatrixMultiplier singleThreadMatrixMultiplier = new org.ixmas.ixmatrixmult.application.singlethread.SingleThreadMatrixMultiplier();
        Matrix m1 = new Matrix(3, 2);
        Matrix m2 = new Matrix(2, 4);
        Matrix m1xm2 = singleThreadMatrixMultiplier.multiply(m1, m2);
    ...
    public void shouldComputeCorrectlyMatrix() {
        ...
        Matrix m3 = singleThreadMatrixMultiplier.multiply(m1, m2);
